...
**1.** We learned the well-known open source APT reports, kill chain model and other materials, then designed a complete set of signal system cyberattack strategies based on the threat analysis results(threat scenarios)
 ...
 - *The "PS script" mentioned in the pic has been submitted to my [repository](https://github.com/jayzheng98/jayzheng98.github.io/blob/master/files/file_monitor.ps1)*

<img alt="p2-5" src="https://github.com/jayzheng98/jayzheng98.github.io/blob/master/images/proj2-5.png?raw=true" width="760px"> </div>
