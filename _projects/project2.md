...
**2.** Due to the large amount of data involved in the graph, it is impossible to visualize them all. Therefore, I only take the <u>specific railway CTI</u> and <u>environmental data</u> dimensions as examples to display the nodes and edges in the constructed graph database:

<div align="center"> <img alt="p2-13" src="https://github.com/jayzheng98/jayzheng98.github.io/blob/master/images/proj2-13.png?raw=true" width="700px"> </div><br>
