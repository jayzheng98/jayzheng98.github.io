...
**1.** This CTI refers to the threat modeling outputs of the target system. In this project, it is generated by [POCA](#threat-analysis). The graph structure of POCA analysis results is shown below:

<div align="center"> <img alt="p2-10" src="https://github.com/jayzheng98/jayzheng98.github.io/blob/master/images/proj2-10.png?raw=true" width="360px"> </div><br>

**2.** Results such as "control action", "weakness" and "threat scenario" can be presented as entities; others like "risk score" and "description" can be used as attributes. Entities are associated through external and internal relationships, for example, nodes in the "threat scenario" entity can form a threat tree through the internal relationship "TS-TS"
...
<div align="center"> <img alt="p2-11" src="https://github.com/jayzheng98/jayzheng98.github.io/blob/master/images/proj2-11.png?raw=true" width="260px"> </div><br>
