...
**2.** This range is composed of the network equipment and other 3 parts:<br><details><summary style="text-align: center; font-size: 14px;"><b>Open to view range component</b></summary>
- **Network Equipment**
...
<div align="center"> <img alt="p2-23" src="https://github.com/jayzheng98/jayzheng98.github.io/blob/master/images/proj2-23.png?raw=true" width="700px"> </div>

### ② Specific railway CTI
**1.** This CTI refers to the threat modeling results of target system. In this project, it is generated by [POCA](#threat-analysis). The graph structure of POCA outputs is shown below:
...
### ③ Environment data
**1.** This dimension is generally based on the topology of the target system and includes attributes such as OS and IP of the equipment. It not only models the physical composition of the environment, but also acts as a bridge between <u>behavior data</u> and <u>CTI</u>
...
## Design
### Detection framework
**1.** From a macro perspective, the behavior studied in this project can be divided into 2 categories: <u>Theoretical threat behavior</u> (CTI in the graph), and <u>Actual abnormal behavior</u> (Bahavior data in the graph). Once a bridge is built to cross the gap between abstract analysis and specific data, effective anomaly detection can be achieved
...
<div align="center"> <img alt="p2-16" src="https://github.com/jayzheng98/jayzheng98.github.io/blob/master/images/proj2-6.png?raw=true" width="640px"> </div><br>
