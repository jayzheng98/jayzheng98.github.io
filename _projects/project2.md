...
## Experiment
**1.** We separately implemented the pre and post penetration by Kali in the shooting range. All the behavior data before and after the implementation (**total 3 days**) have been exported and saved as the **raw dataset**
