...
**1.** The specific railway cyber threat intelligence(CTI) refers to the threat modeling results of target system. In this project, it is generated by [POCA](#threat-analysis). The graph structure of POCA outputs is shown below:
