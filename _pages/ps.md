...
&ensp;&ensp;&ensp;&ensp;&ensp;1) It not only consists knowledge data (</font>[<font size=4>BRON</font>](https://github.com/ALFA-group/BRON)), environment data (assets and topology) and behavior data (system logs), but also effectively integrates the aformentioned threat modeling outputs as the cyber threat intelligence (CTI).<br>
&ensp;&ensp;&ensp;&ensp;&ensp;2) It can be the foundation to further develope model-based AI techniques. The representing, analysing and reasoning about the security and safety of CPS are all explainable.<br><br>
